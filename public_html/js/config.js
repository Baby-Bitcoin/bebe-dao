...
const MIN_TOKEN_BALANCE_FOR_POST = 10000;
const MIN_TOKEN_BALANCE_FOR_VOTE = 10000;
export { RPC_URL, BEBE_MINT_ADDRESS, BEBE_SYMBOL, WSOLMint, MIN_TOKEN_BALANCE_FOR_POST, MIN_TOKEN_BALANCE_FOR_VOTE, };
